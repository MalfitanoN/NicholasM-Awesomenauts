game.SpendGold = Object.extend({
    ...
    startBuying: function(){
        ...
        game.data.buyscreen.setOpacity(0.5);
    ...
    setBuyText: function(){
            game.data.buyText = new(me.Renderable.extend({
                    ...
                    draw: function(renderer){
                        ...
                        this.font.draw(renderer.getContext(), "Increase Damage Current Level: " + game.data.skill1 + " | Cost: " + ((game.data.skill1+1) * 10), this.pos.x + 10, this.pos.y + 80);
                        this.font.draw(renderer.getContext(), "Increase Speed: " + game.data.skill2 + " | Cost: " + ((game.data.skill2+1) * 10), this.pos.x + 10, this.pos.y + 120);
